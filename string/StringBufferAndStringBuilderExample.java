...
Performance test (Time taken)
 ...
 because StringBuilder, although it's unsafe to use for the multi-threading,
 but it is the fastest among all the mutability
 and does not allow multiple threads operations at the same time.
 That's why it is faster as compared to the StringBuffer.
 */
/*
More To Learn...
